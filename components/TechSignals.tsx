  ...
  return (
    <div className="mb-6 print:hidden">
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <span className="font-mono text-[13px] text-r-text font-semibold tracking-[0.15em] uppercase">今日技术风口</span>
        <span className="font-sans text-[13px] text-r-muted">· 驱动今日机会的技术信号</span>
      </div>
